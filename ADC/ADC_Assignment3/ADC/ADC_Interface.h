...
#define INTERNAL_2.56V_REFERENCE0			3 // internal 2.56 Voltage Referance with  external  capacitor  at  AREF pin
...
#define Battery_1.22V_Vbg	30  //Single But i don't know when we use it
